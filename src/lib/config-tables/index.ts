...
import { Tables } from '../../../config_table_code/schema';
...
try {
  // 创建 JSON 文件加载器
  // config_table_data 目录相对于 src 目录的路径
  const jsonLoader = createJsonLoader('../config_table_data');
...
// 导出类型（可选，方便其他模块使用）
export type { Tables } from '../../../config_table_code/schema';
