...
{
    public constant(JsonElement _buf) 
    {
    ...
    public static constant Deserializeconstant(JsonElement _buf)
    {
        return new demo.constant(_buf);
    }
    ...
    public const int __ID__ = 133220175;
