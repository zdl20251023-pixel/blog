...
namespace cfg.demo
{
public sealed partial class ConstantOne : Luban.BeanBase
{
    public ConstantOne(JsonElement _buf) 
    {
        ...
        X8 = _buf.GetProperty("x8").GetString();
        X9 = _buf.GetProperty("x9").GetSingle();
    }

    public static ConstantOne DeserializeConstantOne(JsonElement _buf)
    {
        return new demo.ConstantOne(_buf);
    }
    ...
    public readonly string X8;
    public readonly float X9;
   
    public const int __ID__ = 1880399991;
