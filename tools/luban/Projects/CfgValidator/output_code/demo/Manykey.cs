...
namespace cfg.demo
{
public sealed partial class Manykey : Luban.BeanBase
{
    public Manykey(JsonElement _buf) 
    {
    ...
    public static Manykey DeserializeManykey(JsonElement _buf)
    {
        return new demo.Manykey(_buf);
    }
    ...
    public const int __ID__ = 1276320373;
